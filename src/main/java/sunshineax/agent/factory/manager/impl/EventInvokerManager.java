...
public class EventInvokerManager<T> implements Manager<AgentEventInvoker<T>, T, Void> {
    ...
    public void registry(AgentEventInvoker<T> invoker) {
    ...
    public Class<?> resolverInvoker() {
        return AgentEventInvoker.class;
    }

    private int getPriority(AgentEventInvoker<?> invoker) {
